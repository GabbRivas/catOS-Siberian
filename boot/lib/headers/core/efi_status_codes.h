...
#define EFI_WARN_HEADER         0x0000000000000000
#define EFI_ERROR_HEADER        0x8000000000000000

#define EFIERR(a)  ((EFI_STATUS)(EFI_ERROR_HEADER | ((unsigned long long)(a))))
#define EFIWARN(a) ((EFI_STATUS)(EFI_WARN_HEADER  | ((unsigned long long)(a))))
